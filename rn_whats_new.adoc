...
* * 警报 * 用于查看环境中最新警报的摘要。
* * 服务请求 * 用于查看环境中生成的最新服务请求列表。有关详细信息，请参见 link:sewebiug_dashboard.html["查看Keystone信息板"]。
...
* link:nkfsosm_tenancy_overview.html["Keystone中的租户和多租户"]
* link:sewebiug_dashboard.html["查看Keystone信息板"]
